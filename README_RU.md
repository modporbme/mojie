...
# Официальные адреса Mojie (Magic Ring) (обновлено 15 сентября 2026)
...
## Тарифы
```
| Название тарифа           | Цена     | Оплата     | Трафик в месяц / всего | Срок      | Устройства | Лимит скорости | Выделенная линия | Разблокировка стриминга | Стойка | Совместное использование аккаунта | Примечание                                      |
| ------------------------- | -------- | ---------- | ---------------------- | --------- | ---------- | -------------- | ---------------- | ----------------------- | ------ | --------------------------------- | ----------------------------------------------- |
| Basic (акция)             | ¥168.00  | Ежегодно   | 168G                   | 1 год     | 5          | 5000M          | Доступно         | Поддерживается          | Есть   | Нельзя                            | Автосброс в день заказа                         |
| Pro                       | ¥38.00   | Ежемесячно | 388G                   | Ежемесячно| 5          | 5000M          | Доступно         | Поддерживается          | Есть   | Нельзя                            | Автосброс в день заказа                         |
| Max                       | ¥58.00   | Ежемесячно | 788G                   | Ежемесячно| 5          | 5000M          | Доступно         | Поддерживается          | Есть   | Нельзя                            | Автосброс в день заказа                         |
| 280G [по объёму]          | ¥98.00   | Разово     | 280G                   | Без срока | 5          | 5000M          | Доступно         | Поддерживается          | Есть   | Нельзя                            | До исчерпания трафика; покупки не суммируются   |
| 680G [по объёму]          | ¥258.00  | Разово     | 680G                   | Без срока | 5          | 5000M          | Доступно         | Поддерживается          | Есть   | Нельзя                            | До исчерпания трафика; покупки не суммируются   |
```
