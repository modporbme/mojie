...
# آدرس‌های رسمی موجی (Mojie / حلقه جادویی) (به‌روزرسانی ۱۴ سپتامبر ۲۰۲۶)
...
## بسته‌ها
```
| نام بسته                  | قیمت     | شیوه صورتحساب | ترافیک ماهانه / کل | مدت       | تعداد دستگاه | سقف سرعت | خط اختصاصی | آنلاک استریم | رک اختصاصی | اشتراک‌گذاری حساب | یادداشت                                      |
| ------------------------- | -------- | ------------- | ------------------ | --------- | ------------ | -------- | ---------- | ------------ | ---------- | ----------------- | -------------------------------------------- |
| Basic (تخفیف ویژه)        | ¥168.00  | سالانه        | 168G               | ۱ سال     | ۵            | 5000M    | موجود      | پشتیبانی     | دارد       | مجاز نیست         | بازنشانی خودکار در روز سفارش                 |
| Pro                       | ¥38.00   | ماهانه        | 388G               | ماهانه    | ۵            | 5000M    | موجود      | پشتیبانی     | دارد       | مجاز نیست         | بازنشانی خودکار در روز سفارش                 |
| Max                       | ¥58.00   | ماهانه        | 788G               | ماهانه    | ۵            | 5000M    | موجود      | پشتیبانی     | دارد       | مجاز نیست         | بازنشانی خودکار در روز سفارش                 |
| 280G [بر اساس حجم]        | ¥98.00   | یک‌باره       | 280G               | بدون محدودیت | ۵         | 5000M    | موجود      | پشتیبانی     | دارد       | مجاز نیست         | تا اتمام ترافیک؛ خریدهای متعدد جمع نمی‌شوند  |
| 680G [بر اساس حجم]        | ¥258.00  | یک‌باره       | 680G               | بدون محدودیت | ۵         | 5000M    | موجود      | پشتیبانی     | دارد       | مجاز نیست         | تا اتمام ترافیک؛ خریدهای متعدد جمع نمی‌شوند  |
```
